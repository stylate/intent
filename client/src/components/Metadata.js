    ...
    return (
        <Wrapper>
            <Grid>
                ...
                <Row>
                    <Column key={3} width={15}>Price per item: ${unit_price.toFixed(2)}</Column>
                </Row>
                {volume_discounts && volume_discounts.length != 0
                    ? <Row>
                        <Column key={4} width={15}>
                            <Discount>Discount: {volume_discounts[0].number} pieces for ${volume_discounts[0].price}!</Discount>
                        </Column>
                    </Row>
                    : <div></div>
                }
